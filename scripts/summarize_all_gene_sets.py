#!/usr/bin/env python3
"""
Summarize 5'UTR and 3'UTR TE content across all gene sets.

Generates comprehensive comparison tables showing TE hit counts, strand bias,
and UTR lengths for each gene in all predefined gene sets.
"""
...
def main():
    ...
    gene_list_dir = get_gene_lists_dir()

    # Load strand bias data
    print("Loading TE content data...")
    utr5_data = load_strand_bias(results_dir / '5utr_analysis/strand_bias_by_utr.tsv')
    utr3_data = load_strand_bias(results_dir / 'strand_bias_by_utr.tsv')
